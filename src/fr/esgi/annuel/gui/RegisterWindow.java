...
public class RegisterWindow {
	public static void main(String[] args) {
		...
		final JLabel l_password_key_again = new JLabel(
				"Resaisir mot de passe clef : ");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					int nb_invalid = 0;
					HashMap<String, Boolean> test_mdp = PasswordUtilities
							.isStrongEnough(String.copyValueOf(f_password
									.getPassword()));
					HashMap<String, Boolean> test_mdp_key = PasswordUtilities
							.isStrongEnough(String.copyValueOf(f_password_key
									.getPassword()));
					...
					if (invalid_params_mdp.size() > 0) {
						...
						nb_invalid++;
						JOptionPane.showMessageDialog(null, sbmdp.toString(),
								"Requis", JOptionPane.OK_OPTION);
					...
					if (String.copyValueOf(f_password.getPassword()).equals(
							String.copyValueOf(f_password_again.getPassword()))
							&& !String
									.copyValueOf(f_password_key.getPassword())
									.equals(String.copyValueOf(f_password
											.getPassword())))
						pwds.add(f_password);
					else {
					...
					if (String.copyValueOf(f_password_key.getPassword())
							.equals(String.copyValueOf(f_password_key_again
									.getPassword()))
							&& !String
									.copyValueOf(f_password_key.getPassword())
									.equals(String.copyValueOf(f_password
		...
		f_len_key.setModel(new DefaultComboBoxModel<Integer>(new Integer[] {
				1024, 2048, 4096 }));
		f_len_key
		...
		gl_top.setHorizontalGroup(gl_top.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_top.createSequentialGroup().addContainerGap().addGroup(gl_top.createParallelGroup(Alignment.TRAILING)
						.addComponent(l_password_key_again)
						.addComponent(l_password_key)
						.addComponent(l_password_again)
						.addComponent(l_password)
						.addComponent(l_firstname)
						.addComponent(l_usermail)
						.addComponent(l_pseudo)
						.addComponent(l_lastname)
						.addComponent(lblNewLabel))
				.addGroup(gl_top.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_top.createSequentialGroup().addGap(33)
				.addGroup(gl_top.createParallelGroup(Alignment.LEADING)
						.addComponent(f_lastname,GroupLayout.PREFERRED_SIZE,GroupLayout.DEFAULT_SIZE,GroupLayout.PREFERRED_SIZE)
						.addComponent(f_firstname,GroupLayout.PREFERRED_SIZE,GroupLayout.DEFAULT_SIZE,GroupLayout.PREFERRED_SIZE)
						.addComponent(f_mail,GroupLayout.PREFERRED_SIZE,GroupLayout.DEFAULT_SIZE,GroupLayout.PREFERRED_SIZE)
						.addComponent(f_pseudo,GroupLayout.PREFERRED_SIZE,GroupLayout.DEFAULT_SIZE,GroupLayout.PREFERRED_SIZE)))
				.addGroup(Alignment.TRAILING,gl_top.createSequentialGroup().addGap(33)
				.addGroup(gl_top.createParallelGroup(Alignment.LEADING,false)
						.addComponent(f_password_again,GroupLayout.DEFAULT_SIZE,GroupLayout.DEFAULT_SIZE,Short.MAX_VALUE)
						.addComponent(f_password,GroupLayout.DEFAULT_SIZE,GroupLayout.DEFAULT_SIZE,Short.MAX_VALUE)
						.addComponent(f_password_key,GroupLayout.DEFAULT_SIZE,GroupLayout.DEFAULT_SIZE,Short.MAX_VALUE)
						.addComponent(f_password_key_again,GroupLayout.DEFAULT_SIZE,GroupLayout.DEFAULT_SIZE,Short.MAX_VALUE)
						.addComponent(f_len_key,0,GroupLayout.DEFAULT_SIZE,Short.MAX_VALUE))))))
								.addContainerGap(826, Short.MAX_VALUE)));
		gl_top.setVerticalGroup(gl_top
				.createParallelGroup(Alignment.LEADING)
				.addGroup(
						gl_top.createSequentialGroup()
								.addGap(21)
								.addGroup(
										gl_top.createParallelGroup(
												Alignment.BASELINE)
												.addComponent(l_pseudo)
												.addComponent(
														f_pseudo,
								...
								.addGroup(
										gl_top.createParallelGroup(
												Alignment.BASELINE)
												.addComponent(
														l_password_key_again)
												.addComponent(
														f_password_key_again,
														GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE,
														GroupLayout.PREFERRED_SIZE))
								.addGap(20)
	...
	protected static List<String> createRegisterURL(List<String> details,
			List<JPasswordField> pwd) throws Exception {
		...
		try {
			...
			md_pwd_account.update(String.copyValueOf(pw_account.getPassword())
					.getBytes());
			...
			md_pwd_key.reset();
			md_pwd_key.update(String.copyValueOf(pw_key.getPassword())
					.getBytes());
		...
		String urlConnect = Constants.SRV_URL + ":" + Constants.SRV_PORT + "/"
				+ Constants.SRV_API + "/" + Constants.SRV_REGISTER_PAGE;

		String params = "?" + Constants.PARAM_USER + "=" + details.get(0) + "&"
				+ Constants.PARAM_EMAIL + "=" + details.get(1) + "&"
				+ Constants.PARAM_FIRSTNAME + "=" + details.get(2) + "&"
				+ Constants.PARAM_NAME + "=" + details.get(3) + "&"
				+ Constants.PARAM_PWD + "=" + hashtext + "&"
				+ Constants.PARAM_PWD_KEY + "=" + hashtext_key + "&"
				+ Constants.PARAM_LENGTH + "=" + details.get(4);
